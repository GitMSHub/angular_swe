...
export default {
    ...
    'Buch mit Titel "Gamma" aktualisieren'() {
        ...
        page.sucheBuecherPage()
            .titel(titel)
            .submit()
            .clickTitelErsteZeile(titel)
        page.detailsBuchPage().clickUpdateButton()
        page.updateBuchPage().updateTitel(neuerTitel)
        ...
        page.detailsBuchPage().checkTitel(neuerTitel)
